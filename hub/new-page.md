...
2.5.3. Чтобы назначить пользователей созданному проекту, откройте список в столбце **«Пользователи»** строки проекта. В нём можно добавить пользователя компании или снять уже назначенного. 
...
2.5.4. В окне пользователей проекта нажмите **"Добавить"**
...
2.5.5. Пользователи добавлены. Роль **«Как в организации»** синхронизирует роли, назначенные пользователю во вкладке **«Пользователи»**, с проектом.

Если для проекта нужны другие роли, выберите их в столбце **«Роль»** на вкладке **«Проекты»**.

#### 2.6. Создание ролей {#roles}
...
2.6.1. Чтобы создать роль, перейдите на сайт [_hub.sgnl.pro_](https://hub.sgnl.pro/) → **«Организация» → «Роли»** и нажмите **«Добавить»**.
...
2.6.3. После создания ролей перейдите на вкладку **«Пользователи»**, нажмите на три точки в столбце **«Роль»** и назначьте роль пользователю. При добавлении пользователя в новый проект она будет назначаться автоматически. Одну роль можно назначить нескольким пользователям, например проектировщикам.
...
2.6.4. После этого роли станут доступны в [настройках прав доступа в SIGNAL DOCS](/ru/docs/settings).
...
2.7.3. После выбора фильтров появятся записи журнала. Прокрутите список для просмотра следующих событий. Чтобы экспортировать отображаемые записи в Excel, нажмите на иконку загрузки ![chrome_gyj0l28yhp.png](/chrome_gyj0l28yhp.png).
