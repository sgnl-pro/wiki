---
title: HUB. Администратор — копия для просмотра
description: 
published: true
date: 2026-09-15T11:21:40.862Z
tags: hub
editor: markdown
dateCreated: 2026-09-15T11:21:40.862Z
---

> Копия для просмотра перед обновлением основной статьи. Красные пометки обозначают места для новых скриншотов.
{.is-info}
...
<span style="flex-grow: 1;"><a href="/hub/admin-preview/updates" onclick="event.stopPropagation();" style="color: inherit; text-decoration: none;">🔄 Что нового (история изменений этого функционала)</a></span>
</summary>
...
<span style="color: #c62828; font-weight: 700;">Нужен новый скриншот: страницы таблицы пользователей и экспорт.</span>
...
<span style="color: #c62828; font-weight: 700;">Нужен новый скриншот: таблица проектов вместо прежнего списка пользователей.</span>

2.5.2. В карточке проекта укажите обязательные название, статус и производственный календарь. При необходимости заполните код, коммерческое название, описание, адрес, часовой пояс, даты начала и окончания, стоимость и валюту. Если указана стоимость, выберите валюту; стоимость не может быть отрицательной. Дата окончания не должна быть раньше даты начала. Доступные статусы: **«Ожидание»**, **«В работе»**, **«Финальная стадия»** и **«Завершён»**. Для автоматического добавления новых пользователей компании включите **«Проект по умолчанию для новых пользователей»** и сохраните проект.

<span style="color: #c62828; font-weight: 700;">Нужен новый скриншот: новые свойства проекта и настройка проекта по умолчанию.</span>
...
2.5.3. Чтобы назначить пользователей созданному проекту, откройте список в столбце **«Пользователи»** строки проекта. В нём можно добавить пользователя компании или снять уже назначенного. Для более подробного редактирования откройте окно пользователей проекта из этого же столбца.

![chrome_lxfttzmvzy.png](/chrome_lxfttzmvzy.png)

2.5.4. В окне пользователей выберите нужных участников и сохраните изменения.

![chrome_a2crmth2zp.png](/chrome_a2crmth2zp.png)

<span style="color: #c62828; font-weight: 700;">Нужен новый скриншот: столбец пользователей и новое окно редактирования пользователей проекта.</span>
...
<span style="color: #c62828; font-weight: 700;">Нужен новый скриншот: выбор роли «Как в организации».</span> Если для проекта нужны другие роли, выберите их в столбце **«Роль»** на вкладке **«Проекты»**.
...
#### 2.8. Контрагенты {#counterparties}
На вкладке **«Контрагенты»** можно добавить компанию-контрагента, найти её по названию и открыть карточку для редактирования. Контрагента можно назначить пользователю в столбце **«Компания»** на вкладке **«Пользователи»**. Выделите несколько пользователей, чтобы назначить одного контрагента всем выбранным. Назначение можно убрать, оставив поле пустым.

<span style="color: #c62828; font-weight: 700;">Нужен новый скриншот: назначение контрагента пользователям.</span>
...
<span style="color: #c62828; font-weight: 700;">Нужен новый скриншот: выбор системного S3-хранилища для проекта.</span>
...
<span style="color: #c62828; font-weight: 700;">Нужен новый скриншот: создание интеграции и список подключений.</span>
...
<span style="color: #c62828; font-weight: 700;">Нужен новый скриншот: список подключений AD и SSO и настройка LDAP/OIDC.</span>
#
<sub>**[<   HUB. Введение](/ru/hub/intro)     **|**     [HUB. Пользователь   >](/ru/hub/user)**</sub>
