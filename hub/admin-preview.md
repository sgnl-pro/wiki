...
2.5.2. В появившемся окне заполните поля, выберите производственный календарь и нажмите **Добавить**. При необходимости включите **«Проект по умолчанию для новых пользователей»** — новые пользователи компании будут автоматически добавляться в этот проект.

<span style="color: #c62828; font-weight: 700;">Нужен новый скриншот: настройка проекта по умолчанию.</span>
...
Контрагент пользователя также попадает в экспорт таблицы пользователей. Подробнее об изменении см. [релиз 2026.15](/general/updates/2026-15).
...
#### 3.1. S3 Сервер
На вкладке настроек S3-хранилищ можно назначить хранилище для проектов компании. Для отдельного проекта доступен выбор системного хранилища SIGNAL или подключённого хранилища компании. Выберите проект, хранилище и сервисы, для которых оно будет использоваться, затем сохраните назначение. Подробнее об изменении см. [релиз 2026.16](/general/updates/2026-16).
