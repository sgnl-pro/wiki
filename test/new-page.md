...
<div class="toc-grid">
  ...
  <div class="toc-card toc-purple">
    ...
    <ul class="toc-list">
      ...
      <li><a href="#company"><span class="toc-badge">2.7</span> Дополнительно</a></li>
    </ul>
  </div>
...
2.2.10. После добавления пользователи появятся на вкладке **«Пользователи»**. Им можно назначить роли, проекты, контрагента и лицензии. Для просмотра большого списка используйте переключение страниц внизу таблицы. При экспорте таблицы в Excel доступны также сведения о проектах и контрагенте пользователя.
...
2.2.11. Для назначения лицензий пользователям перейдите в раздел **Организация → Пользователи.**

2.2.12. Чтобы назначить лицензию Пользователю, кликните на пересечении Пользователь — Приложение:

![chrome_6xkhvhkou9.png](/chrome_6xkhvhkou9.png)

2.2.13. Для всех сервисов SIGNAL можно выдать лицензии для Пользователя или Администратора. У Администраторов расширенные возможности пользования сервисами SIGNAL.
...
2.3.3. Чтобы назначить пользователей созданному проекту, откройте список в столбце **«Пользователи»** строки проекта. В нём можно добавить пользователя компании или снять уже назначенного. 
...
2.3.4. В окне пользователей проекта нажмите **"Добавить"**
...
2.3.5. Пользователи добавлены. Роль **«Как в организации»** синхронизирует роли, назначенные пользователю во вкладке **«Пользователи»**, с проектом.

Если для проекта нужны другие роли, выберите их в столбце **«Роль»** на вкладке **«Проекты»**.

#### 2.4. Создание ролей {#roles}
...
2.4.1. Чтобы создать роль, перейдите на сайт [_hub.sgnl.pro_](https://hub.sgnl.pro/) → **«Организация» → «Роли»** и нажмите **«Добавить»**.

![chrome_pp2y5gsvlb.png](/chrome_pp2y5gsvlb.png)

2.4.2. В появившемся окне задайте название роли и нажмите **«Добавить»**.
...
2.4.3. После создания ролей перейдите на вкладку **«Пользователи»**, нажмите на три точки в столбце **«Роль»** и назначьте роль пользователю. При добавлении пользователя в новый проект она будет назначаться автоматически. Одну роль можно назначить нескольким пользователям, например проектировщикам.
...
2.4.4. После этого роли станут доступны в [настройках прав доступа в SIGNAL DOCS](/ru/docs/settings).

#### 2.5 Логи и отслеживание
###### 2.5 Логи и отслеживание {#log}
  
2.5.1. Для того чтобы перейти к мониторингу действий пользователей в проектах, нужно в разделе «Организация», открыть вкладку «Логи».
  
  ![chrome_4ijt6fexyw.png](/chrome_4ijt6fexyw.png)
  
2.5.2. В верхней части открывшегося окна показаны фильтры. По ним можно отфильтровать период с какого - по какое необходимо вывести журнал, по какому проекту, какой пользователь, в каком модуле и какое действие выполнено.
  
  ![chrome_cfhzxafjlq.png](/chrome_cfhzxafjlq.png)
  
2.5.3. После выбора фильтров появятся записи журнала. Прокрутите список для просмотра следующих событий. Чтобы экспортировать отображаемые записи в Excel, нажмите на иконку загрузки ![chrome_gyj0l28yhp.png](/chrome_gyj0l28yhp.png).

![excel_co1rkpshao.png](/excel_co1rkpshao.png)
  
#### 2.6. Компании {#counterparties}
