...
Для каждого типа формы можно настроить маршрут согласования – список этапов, которые должны пройти формы при заполнении.

Свойство этапа | Обязательность | Описание
:----- | :----- | :-----
**Номер** | Да |	Очередность прохождения. Этапы можно менять местами.
...
**Формула расчёта срока** | Нет |	Переопределение срока в зависимости от значений полей (например, если поле «Важность» = «Критично», а поле «Сложность = «Средняя» срок 3 дня и т.д.).
