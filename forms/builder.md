...
Поля, получающие данные из других объектов, объединены в меню **«Значение из источника»**. В нём доступны следующие типы — в указанном порядке:
...
**<span style="color: #D32F2F;">СКРИНШОТ: раскрытое меню «Значение из источника» при добавлении поля. Типы должны быть показаны в порядке: «Форма», «Замечание», «Комплект согласования», «Передача», «Вид работ», «Материал», «НТД», «Контрагент», «Пользователь».</span>**
