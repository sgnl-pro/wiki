...
**Префикс** | Короткая буквенная метка для идентификации. Она будет автоматически добавляться к номеру экземпляра формы в проекте. | `АОСР` 
...
Группы и формы можно перемещать для правильной сортировки.
