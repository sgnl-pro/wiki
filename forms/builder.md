...
**Значение из источника** | Выбор одной или нескольких завершённых форм проекта определенного типа с заданными, при необходимости, условиями фильтрации.
**Вид работы** | Выбор одного или нескольких значений из справочника видов работ компании HUB.
...
**<span style="color: #D32F2F;">СКРИНШОТ: меню добавления полей с типами «Вид работы», «Материал», «НТД», «Замечание», «Комплект согласования», «Передача», «Пользователь» и «Контрагент».</span>**
...
:----- | :----- | :-----
**Множественный выбор**  | `Список вариантов` `Файл` `Значение из источника` `Вид работы` `Материал` `НТД` `Замечание` `Комплект согласования` `Передача` `Пользователь` `Контрагент` | Галочка, можно ли при заполнении формы задавать несколько значений или только одно.
...
**Источник**  | `Значение из источника` | Один тип форм и, при необходимости, условия фильтрации по значениям его полей. Например, можно выводить только формы, у которых значение поля совпадает со значением поля текущей формы.
