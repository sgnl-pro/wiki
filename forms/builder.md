...
![конструктор.png](/forms/конструктор.png =1200x![конструктор.png](/forms/конструктор.png))
...
Поля можно перемещать для правильной очередности отображения.
