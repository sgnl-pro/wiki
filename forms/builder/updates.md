...
<span style="flex-grow: 1;"> <a href="/forms/builder" onclick="event.stopPropagation();" style="color: inherit; text-decoration: none;">Здесь описаны изменения функционала по релизам. См. также основную статью: <b>FORMS. Конструктор</b></a></span>
</summary>