...
Чтобы открыть настройки проекта, выберите проект и нажмите кнопку настроек на его главной странице.
 
...
Вкладка доступна администратору приложения INSPECTION и суперпользователю в административном интерфейсе. Здесь настраиваются получатели уведомления о загрузке фотографии в проект. Нажмите кнопку добавления и выберите тип получателя: «Пользователь», «Роль» или «Email». Затем укажите получателя и сохраните настройки. При необходимости получателя можно удалить из списка.

<span style="color:Red">Здесь нужен новый скриншот вкладки «Уведомления» с выбором получателей.</span>

### Вкладка «Перенос»

Вкладка доступна только суперпользователю в административном интерфейсе. Она позволяет перенести данные между проектами: укажите идентификаторы исходной и целевой компании и проекта, сначала нажмите «Проверить», затем — «Применить».
