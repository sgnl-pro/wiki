...
![image-1683727741068.png](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdu8f25f7kGSPzjhJv2vFhna81ypRX8_cv5oI0hc4051lB6n6rv0o3n8tw-7Ph0_7faxSKJbSls5rs-Nz4ztsTBFBgHOyN7ke-rf4npjcxscjRsetrAsdtitzXeHvAkQl5L1zrdcinyH9rA0SGdKg?key=XMH0iYHEflHj_Yg5tgZfCQ)
  #### По комплектам
  ###### По комплектам {#by_sets}
  > Инструмент позволяет раскрасить элементы модели по комплектам "Категория-Свойство" найденным в проекте
{.is-info}
  
  При нажатии на кнопку **По комплектам** программа по всему проекту найдет сущестующие Категории и их Свойства.
  
  **Окно Раскраски по комплектам - лента Категорий**
  ![roamer_1k5ys8ysva.png](/roamer_1k5ys8ysva.png)
  
  **Окно Раскраски по комплектам - лента Свойств**
  ![roamer_paoly5ahix.png](/roamer_paoly5ahix.png)
  
  Свойства фильтруются в зависимости от выбранной Категории. В каждой Категории будут использованы собственные Свойства.
  
  Таким образом можно для **Категории "Элемент"** **Свойства "Материал"** выделить **класс бетона** и раскрасить их по определенным цветам. Или разукрасить **вытяжную** и **приточную** вентиляцию в зависимости от условий.
  ![roamer_oty5dp0qzh.png](/roamer_oty5dp0qzh.png)
  
  После назначения цветов, все используемые цвета на элементах собираются в Наборе **UserColor**. Сами элементы разукрашенные в определенные цвета получают новую категорию SIGNAL, и свойство UserColor со значением цвета.
  ![roamer_upaiubzilp.png](/roamer_upaiubzilp.png)
