...
# Вкладки{.tabset}
## 90_Интеграция
###### 90_Интеграция {#caed-90}
  
Карточка позволяет загрузить ссылку на любой сайт из интернета и просматривать его через DASHBOARD:
...
Вставьте ссылку на нужный сайт и нажмите **Сохранить:**
...
Карточка для быстрого перехода по указанной ссылке:
...
## 92_Ссылка Youtube
###### 92_Ссылка Youtube {#card-92}
 
Карточка позволяет просматривать видео с YouTube прямо на слайде:
...
При нажатии на карточку откроется указанное видео с видеохостинга YouTube:
...
Скопируйте идентификатор из пути к видеоролику YouTube и вставьте его в поле редактирования слайда:
