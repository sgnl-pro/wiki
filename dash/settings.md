...
:fire: Реализовали возможность встраивания содержимого карточек во внешние системы, например корпоративных порталах компаний.
 
:sparkles: Отдельно вынесли доступы для операций с отчётом (шестеренка): создание, удаление, публикация отчёта, изменение показателей. В карандашике остались доступы к группам и карточкам.
  
:sparkles: Добавили возможность не скрывать, а деактивировать карточки на вкладке "Управление" — деактивированные карточки визуально выделяются серым цветом и становятся некликабельными. Такой режим можно использовать, чтобы пользователь однозначно понимал, что заполнение или редактирование данных для этого элемента больше не требуется.
 
:sparkles: Добавили сворачивание групп карточек.
  
----
**[2026.4](/general/updates/2026-4)** ^12.03.2026^
  
:sparkles: Скрыли карточки, при создании у которых написано `(будет скрыта)`.
  
----
**[2026.3](/general/updates/2026-3)** ^03.03.2026^
  
:sparkles: Расширили права доступа к показателям: пользователи с правами на редактирование теперь могут публиковать отчёт.

:sparkles: Доработали экспорт карточек в DOCX, в том числе добавили вариант полистного экспорта как в PDF.
  
----
**[2026.2](/general/updates/2026-2)** ^12.02.2026^
  
:sparkles: Добавили доступы на уровне общих показателей, которые наследуются от доступов проекта, а также могут настраиваться самостоятельно через карандашик.
  
:sparkles: Расширили доступы на уровне групп: доступ на редактирование всего проекта или группы позволяет добавлять карточки. Доступ на редактирование всего проекта также позволяет публиковать отчет.
