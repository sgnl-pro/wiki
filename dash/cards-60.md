...
:hammer_and_wrench: Сделали, чтобы в нужном случае выводился статус Согласовано с замечаниями вместо Согласовано в карточках 65.
  
:hammer_and_wrench: Исправили фильтрацию в карточке 66 на дату завершения согласования, вместо даты начала.
...
# Вкладки{.tabset}
## 62_Замечания DOCS
###### 62_Замечания DOCS {#card-62}
  
Карточка отображает все статусы замечаний SIGNAL DOCS в виде графика.
...
## 63_Общая по согласованиям в DOCS
###### 63_Общая по согласованиям в DOCS {#card-63}

Карточка позволяет отобразить статистику по согласованиям из SIGNAL DOCS в виде круговой диаграммы.
...
## 64_Динамика согласований в DOCS
###### 64_Динамика согласований в DOCS {#card-64}
  
Карточка для отображения графика по согласованиям. Предназначена для анализа динамики выпуска документации.
...
## 65_Реестр согласований в DOCS
###### 65_Реестр согласований в DOCS {#card-65}
  
Карточка отображает реестр согласований из SIGNAL DOCS.
...
## 66_SLA по Ролям
###### 66_SLA по Ролям {#card-66}

Карточка отображает процент завершенных вовремя проверок по ролям пользователей в выбранном проекте  
...
## 67_SLA по Согласованиям
###### 67_SLA по Согласованиям {#card-67}
  
Карточка отображает процент завершенных вовремя проверок по типам согласований в выбранном проекте  
