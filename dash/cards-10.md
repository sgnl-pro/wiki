...
:sparkles: В карточке 15 при наведени на область теперь выводим значение области за соответствующий месяц.
  
:hammer_and_wrench: Поправили, чтобы карточка 15 не ломалась из-за нового поля Тип в Google-таблице.
