...
# Вкладки{.tabset}
## 30_Процент срока реализации
###### 30_Процент срока реализации {#card-30}

Карточка показывает основные сведения по сроку реализации проекта: начало и окончание работ, срок сдачи объекта, сколько всего календарных дней занимает реализация объекта и сколько календарных дней прошло с момента начала работ.
...
## 31_Вехи на проекте
###### 31_Вехи на проекте {#card-31}
  
Карточка показывает процент выполнения работ в виде вех. В качестве исходных данных используется XML файл из MS Project.
