...
![image-1689148960852.png](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfG9n71VIjktr-L98p9lYa7MI8Fyrwzp1ra0kxcXxzKWSyWFy9HZ37XKtZX6iZi1LD4EBkT_P7gslc2S886sLChtnvleuPsXrnC4MBNmDS6sZJW73CbEMqdH4ugh5oTRoDhUEn43Wq6jQHRqvhWLg?key=fbjahmDVrqngiYxvm4q7FA)
  ...
  ## Отчет компании
  Отчет компании создается в отдельном окне "Отчет компании", которое находится в выпадающем списке при нажатии на проект.
  
  ![chrome_9fh9mjqgbe.png](/chrome_9fh9mjqgbe.png)
  
  В отчете компании доступны те же создания групп карточек, однако самих карточек в нескольк раз меньше чем в оригинальном отчете проекта. Всего представлено 3 вида карточки: 10_Альбомы, 11_ТЭПы, 91_Ссылка.
  
  ![chrome_zjsf4kzjq8.png](/chrome_zjsf4kzjq8.png)
  ## Отчет пользователя
  Отчет пользователя создается в отдельном окне "Мой отчет", которое находится в выпадающем списке при нажатии на проект.
  
  ![chrome_c0pkgk0e7y.png](/chrome_c0pkgk0e7y.png)
  
  В отчете пользователя, также как и в Отчете компании создаются группы карточек и также как и в Отчете компании предоставлены только три вида карточек: 10_Альбомы, 11_ТЭПы, 91_Ссылка.
