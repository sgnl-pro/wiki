...
![создание_комплекта_2.gif](/faq/создание_комплекта_2.gif)
...
|-------------|----------------------|----------------------|
  ...
  Обработка в модели в Forge Viewer| ForgeModelNitOnErrorState| Модель уже находится в очереди на обработку, дождитесь ее обработки|
