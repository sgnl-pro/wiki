...
Далее откройте каждый файл комплекта, поставьте к нему замечания или утвердите без замечаний. После проверки всех файлов и проставления каждому из них статуса нажмите **Завершить этап.** При необходимости напишите комментарий. Документация перейдет следующему проверяющему:
