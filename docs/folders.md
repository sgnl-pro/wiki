...
**Способ 3.** Если в системе уже загружен файл предыдущей версии, загрузите следующую версию через контекстное меню файла: нажмите на файл правой кнопкой мыши и выберите **Загрузить версию**.

Способ подходит, даже если название файла на компьютере и название файла в SIGNAL DOCS не совпадают.
...
**Пакетное обновление версий**

Чтобы загрузить новые версии сразу для нескольких файлов:

1. Выделите файлы в папке. Если вместе с файлами выделены папки, система не добавит их в список обновления.
2. Нажмите на один из выделенных файлов правой кнопкой мыши и выберите **Загрузить версию**.
3. Выберите на устройстве файлы с новыми версиями. Система автоматически сопоставит файлы с одинаковыми именами. Если однозначного совпадения по имени нет, система также может сопоставить единственную пару файлов с одинаковым расширением.
4. Проверьте пары в окне сопоставления. Перетащите файл к нужному файлу DOCS, чтобы изменить пару. При необходимости добавьте или удалите файлы как со стороны DOCS, так и со стороны устройства.
5. Нажмите **Загрузить**. Если сопоставлены не все файлы DOCS, подтвердите загрузку только сопоставленных пар или вернитесь к редактированию.

Для каждого файла можно выбрать только новую версию с тем же расширением. Если файл DOCS занят другим пользователем, обновить его версию нельзя: сначала дождитесь освобождения файла.

![Окно сопоставления файлов для пакетного обновления версий](/release_notes/2026-17-обновление_версий.png =1200x)
...
**Способ 2. Настройки прав доступа в настройках проекта**
