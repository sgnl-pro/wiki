...
**:fire: Реализовали функционал создания и редактирования графиков Гантта в DOCS в собственном расширении .sgmpp, который в дальнейшем планируем развивать в отдельном модуле для постановки задач.**
