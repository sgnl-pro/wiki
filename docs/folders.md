...
> В SIGNAL DOCS доступно подписание документов с помощью ручной подписи, которую можно вставить из файла изображения или нарисовать прямо в сервисе. Все созданные подписи сохраняются для повторного использования
{.is-info}
...
После выбора файла подписи нажмите подтвердить и выберите место размещения подписи на листе, а также настройте ее масштаб. Также будет открыто окно со всеми подписями в документе. Вы можете располагать одну или несколько подписей на разных листах, управляя ими через это окно.
