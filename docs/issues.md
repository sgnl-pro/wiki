...
> - <span style="color: #0695D7; font-weight: bold">Открыто</span> — замечание назначено ответственному, он уведомлён.
> - <span style="color: #F2C94C; font-weight: bold">В работе</span> — ответственный согласен с замечанием и приступил к устранению.
> - <span style="color: #4FCDA6; font-weight: bold">На проверке</span> — ответственный загрузил исправленную версию файла и ждёт проверки от автора (или проверяющего).
...
> - <span style="color: #FF4758; font-weight: bold">Не принято</span> — проверяющий не удовлетворён устранением, замечание возвращается в работу.
> - <span style="color: #B6BEC7; font-weight: bold">Удалено</span> — замечание создано ошибочно и помечено как удалённое.
>
> При изменении статуса уведомления отправляются ответственному, автору и наблюдателям.

> **Ответственный** — пользователь или роль, назначенные на замечание для его устранения. Ответственный может менять статус («В работе», «На проверке», «Отклонено»), писать комментарии, загружать новые версии файлов. Уведомления о создании и изменении замечания отправляются ответственному на email.

> **Автор замечания** — пользователь, создавший замечание. Автор может редактировать замечание (кроме случаев, когда это ограничено правами), изменять его статус на «Закрыто» или «Не принято», а также удалять замечание, если оно ещё не в работе.
