...
![](https://lh7-rt.googleusercontent.com/docsz/AD_4nXcqjzCT7pIOvIz2ViG_zAJRYbx94u3I9Af9JcucJfwwj8jGxUGKnN9X1OvVrSAvvfpdduVJrovpORRYqR5czu98I2pTK3dDqUQkdSUs9d0HIxEN0ckHWNY625wZFxV-c1XF7vqTzS7wL9pRHKak?key=cnL3kvpEZPujFMNQA9w79A =70%x)
  ...
  В настройках типов замечаний, в графе Шаблон документа, загрузите ваш файл предписания в котором хотите видеть информацию по замечанию. Информация в документе записывается через ключи **(более подробно см. [Настройка шаблона](https://wiki.sgnl.pro/ru/docs/settings#temp_doc)**). 
...
| `{{IssueViewed}}`          | **Просмотрено замечание** | Выписывает кем просмотрено замечание                                                       |
