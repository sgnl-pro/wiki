...
>
> При изменении статуса уведомления отправляются ответственному, автору и наблюдателям.

> **Ответственный** — пользователь или роль, назначенные на замечание для его устранения. Ответственный может менять статус (<span style="color: #0695D7; font-weight: bold">В работе</span>, <span style="color: #FF76E0; font-weight: bold">На проверке</span>, <span style="color: #FF4758; font-weight: bold">Отклонено</span>), писать комментарии, загружать новые версии файлов. Уведомления о создании и изменении замечания отправляются ответственному на email.

> **Автор замечания** — пользователь, создавший замечание. Автор может редактировать замечание (кроме случаев, когда это ограничено правами), изменять его статус на <span style="color: #4FCDA6; font-weight: bold">Закрыто</span> или <span style="color: #9D7A6C; font-weight: bold">Не принято</span>, а также удалять замечание, если оно ещё не в работе.

> **Наблюдатели** — пользователи или роли, которые получают уведомления обо всех изменениях замечания (комментарии, смена статуса, вложения), но не обязаны его устранять. Наблюдатели могут просматривать замечание и оставлять комментарии.
...
> **Комментарии** — текстовые сообщения в ленте замечания, позволяющие вести диалог между автором, ответственным и наблюдателями. Комментарии могут содержать ссылки на пометки (с индексом пометки) и прикреплённые файлы.
