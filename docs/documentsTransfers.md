...
> - перечень файлов с их именами, размерами и хэш-суммами, сгенерированными [алгоритмом ГОСТ 2012-256](https://cryptopro.ru/sites/default/files/products/csp/rus-popov-x509-gost-00-re.pdf);
