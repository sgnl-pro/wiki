...
#### 3.2. Работа с файлами черновика
##### 3.2. Работа с файлами черновика {#files}
...
#### 3.3. Формирование акта
##### 3.3. Формирование акта {#act}
...
#### 3.4. Подтверждение отправителем
##### 3.4. Подтверждение отправителем {#senderSigning}
...
#### 3.5. Отправка получателю
##### 3.5. Отправка получателю {#sending}
...
#### 3.6. Действия получателя
##### 3.6. Действия получателя {#recipientSigning}
...
#### 3.7. Скачивание документации
###### 3.7. Скачивание документации {#downloading}
