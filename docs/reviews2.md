...
В реестре отображаются комплекты согласований и их свойства, а также основные свойства активной (последней запущенной) итерации. 

Действие с реестром | Кому доступно   | Описание
:----- | :----- | :-----
Просмотр комплектов   | Кому доступно   | описание
Фильтрация и поиск  | описание   | описание
Просмотр / скрытие календаря   | описание   | описание
Настройка колонок   | описание   | описание
Создание комплекта   | описание   | описание
Редактирование комплекта   | описание     | описание
Импорт комплектов из XLSX   | описание   | описание
Экспорт в XLSX  | описание   | описание
Удаление комплекта   | описание   | описание
  
  
Колонка реестра | Описание
:----- | :-----
Номер   | Сквозной порядковый номер комплекта в проекте. Назначается автоматически при создании комплекта.
Шифр  | описание
Название  | описание
Договорная дата  | описание
Тип согласования  | описание
