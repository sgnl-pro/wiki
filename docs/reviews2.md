...
Действие с реестром | Описание
:----- | :-----
Просмотр комплектов   | описание
Фильтрация и поиск  | описание
Просмотр / скрытие календаря   | описание
Настройка колонок   | описание
Создание комплекта   | описание
Редактирование комплекта   | описание  
Импорт комплектов из XLSX   | описание  
Экспорт в XLSX  | описание 
Удаление комплекта   | описание  
